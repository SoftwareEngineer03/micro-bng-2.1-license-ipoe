...
# setup and teardown for tests that required running dhclient (after micro-bngd)
@pytest.fixture()
def dhclient_instance(micro_bngd_instance, veth_pair_netns, dhclient, dhclient_args):
    # test setup:
    print("dhclient_instance: micro_bngd_instance = " + str(micro_bngd_instance))
