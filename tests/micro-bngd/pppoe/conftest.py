...
# setup and teardown for tests that required running pppd (after micro-bngd)
@pytest.fixture()
def pppd_instance(micro_bngd_instance, veth_pair_netns, pppd, pppd_args):
    # test setup:
    print("pppd_instance: micro_bngd_instance = " + str(micro_bngd_instance))
