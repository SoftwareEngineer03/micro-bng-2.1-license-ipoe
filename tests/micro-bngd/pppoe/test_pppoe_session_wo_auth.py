...
def test_pppoe_session_wo_auth(pppd_instance, bng_cmd):

    # test that pppd (with micro-bngd) started successfully
    ...
    print("test_pppoe_session_wo_auth: last bng-cmd out: " + out)
