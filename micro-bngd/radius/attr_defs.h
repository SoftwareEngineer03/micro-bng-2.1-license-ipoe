...
#define       MicroBNG_Bandwidth_Max_Up              1
#define       MicroBNG_Bandwidth_Max_Down            2
#define       MicroBNG_Bandwidth_Min_Up              3
#define       MicroBNG_Bandwidth_Min_Down            4
// Quality of Service
#define       MicroBNG_QoS_Profile                   5
// Access and rate limiting
#define       MicroBNG_Access_Policy                 6
#define       MicroBNG_Rate_Limit_Session            7
// Session management
#define       MicroBNG_Session_Terminate_Time        8
#define       MicroBNG_Session_Terminate_Action      9

#define       MicroBNG_DNS_Primary                   10
#define       MicroBNG_DNS_Secondary                 11
