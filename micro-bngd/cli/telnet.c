...
static const char *conf_history_file = "/var/lib/micro-bng/history";
...
{
	if (telnet_send(cln, "micro-bng version " MICRO_BNG_VERSION "\r\n", sizeof("micro-bng version " MICRO_BNG_VERSION "\r\n")))
		return -1;
	return 0;
}
