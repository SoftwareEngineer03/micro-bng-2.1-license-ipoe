...
struct pppoe_serv_t
{
  ...
  obj_hash_table_t cookie_2_conn;
  hash64_table_t mac_sessid_2_conn;
...
struct pppoe_interface_config_t
{
	char *ifname;
	char *service_name[255];
	int accept_any_service;
	int accept_blank_service;
};

#define MAX_CONF_INTERFACES 12000
...
struct interface_pado_delay_s
{
    struct list_head dpado_range_list;
    struct dpado_range_t *dpado_range_next;
    struct dpado_range_t *dpado_range_prev;
    int pado_delay;
...
extern int conf_accept_blank_service;
extern char *conf_ac_name;
extern char *conf_pado_delay;

extern struct pppoe_interface_config_t conf_interface_config[];
extern obj_hash_table_t *ptr_conf_interface_pado_delay;

extern unsigned int stat_starting;
extern unsigned int stat_session_active;
...
extern unsigned long PADI_per_Second;
