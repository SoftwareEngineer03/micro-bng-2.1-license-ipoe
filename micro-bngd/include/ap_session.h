...
struct ppp_info_s
{
  ...
  uint8_t addr[ETH_ALEN]; // client mac
  uint16_t pppoe_sid;
  int vid;
};
...
struct ap_session
{
	...
	uint32_t vpp_pppoe_sw_if_index;
  ...
  /********** for show sessions **********/
  in_addr_t peeraddr_4showsessions;
  struct in6_addr ip6addr_4showsessions;
  struct in6_addr ip6dp_4showsessions;
  int ip6addr_prefixlen;
  int ip6dp_prefixlen;
  char *comp_4showsessions;
  char *ctrl_name;
  char *ctrl_ifname;
  char *ctrl_service_name;
  char *ctrl_calling_station_id;
  char *ctrl_called_station_id;
  /********** for show sessions **********/

  uint32_t download_ipv6_classify_table_index;
	
	int microbng_bandwidth_max_up;
	int microbng_bandwidth_max_down;
	int microbng_bandwidth_min_up;
	int microbng_bandwidth_min_down;

  unsigned int ipv6_started:1;
};
