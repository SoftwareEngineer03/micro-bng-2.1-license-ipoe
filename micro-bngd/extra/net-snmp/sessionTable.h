...
/* other required module components */
    /* *INDENT-OFF*  */
config_add_mib(MICRO-BNG-MIB)
config_require(MICRO-BNG-MIB/sessionTable/sessionTable_interface)
config_require(MICRO-BNG-MIB/sessionTable/sessionTable_data_access)
config_require(MICRO-BNG-MIB/sessionTable/sessionTable_data_get)
config_require(MICRO-BNG-MIB/sessionTable/sessionTable_data_set)
    /* *INDENT-ON*  */
